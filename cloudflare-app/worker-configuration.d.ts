/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: faa7d5483e046661e9e14333a29dc3ef)
...
interface __BaseEnv_Env {
	...
	PUBLIC_ORIGIN: "https://bitworld-console.hans-pan007.workers.dev";
	DEEPSEEK_BASE_URL: "https://api.deepseek.com";
	FEISHU_CALLBACK_ORIGIN: "https://bitworld-feishu-relay.pages.dev";
	RESEND_FROM_EMAIL: "BitWorld <bitworld@midastrade.asia>";
	ADMIN_PASSWORD: string;
	SESSION_SECRET: string;
	DASHSCOPE_API_KEY: string;
	COMPANY_WORKFLOW: Workflow<Parameters<import("./worker/index").CompanyWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_NAME" | "ENVIRONMENT" | "PUBLIC_ORIGIN" | "DEEPSEEK_BASE_URL" | "FEISHU_CALLBACK_ORIGIN" | "RESEND_FROM_EMAIL" | "ADMIN_PASSWORD" | "SESSION_SECRET" | "DASHSCOPE_API_KEY">> {}
}
