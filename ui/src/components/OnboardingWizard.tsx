  ...
  async function handleUnsetAnthropicApiKey() {
    ...
    try {
      ...
      if (result?.status === "fail") {
        setError(
          "已在适配器配置中清除 ANTHROPIC_API_KEY 并重试，但环境测试仍然失败。"
        );
      }
    } catch (err) {
      setError(
              ...
              {step === 1 && (
                <div className="space-y-5">
                  <div className="flex items-center gap-3 mb-1">
                    ...
                    <div>
                      <h3 className="font-medium">为你的公司命名</h3>
              ...
              {step === 2 && (
                <div className="space-y-5">
                  <div className="flex items-center gap-3 mb-1">
                    ...
                    <div>
                      <h3 className="font-medium">创建你的第一个 Agent</h3>
                      <p className="text-xs text-muted-foreground">
                        选择该 Agent 运行任务的方式。
                      </p>
                    </div>
                    ...
                    <div className="space-y-3">
                      <div>
                        <div className="flex items-center gap-1.5 mb-1">
                          ...
                          <HintIcon text="Paperclip 建议你为 Agent 创建一个新文件夹来保存记忆和保持整理。创建一个新文件夹并将路径填写在此。" />
                        </div>
                      ...
                      {shouldSuggestUnsetAnthropicApiKey && (
                        <div className="rounded-md border border-amber-300/60 bg-amber-50/40 px-2.5 py-2 space-y-2">
                          <p className="text-[11px] text-amber-900/90 leading-relaxed">
                            ...
                            时 Claude 失败。你可以在此 CEO 适配器配置中清除它并重试探测。
                          </p>
                          <Button
                            size="sm"
                            variant="outline"
                ...
                <div className="space-y-5">
                  <div className="flex items-center gap-3 mb-1">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">
                        给你的 Agent 一个小任务开始——修复 bug、调研问题或编写脚本。
                      </p>
                    </div>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      placeholder="添加更多关于 Agent 应该做什么的详细说明..."
                ...
                <div className="space-y-5">
                  <div className="flex items-center gap-3 mb-1">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">
                        一切就绪。启动后将创建初始任务、唤醒 Agent 并打开事项。
                      </p>
                    </div>
                  </div>
